...
def getDirectionByOpType(opt):
    if opt in (
        OPT_BUY,
        OPT_OPEN_LONG,
        OPT_CLOSE_SHORT_TODAY_HISTORY_THEN_OPEN_LONG,
        OPT_CLOSE_SHORT_HISTORY_TODAY_THEN_OPEN_LONG,
        OPT_CLOSE_SHORT_TODAY,
        OPT_CLOSE_SHORT_HISTORY,
        OPT_CLOSE_SHORT_TODAY_FIRST,
        OPT_CLOSE_SHORT_HISTORY_FIRST,
        OPT_FIN_BUY,
        OPT_FIN_BUY_SPECIAL,
        OPT_BUY_SECU_REPAY,
        OPT_BUY_SECU_REPAY_SPECIAL,
        OPT_OPTION_BUY_CLOSE,
        OPT_OPTION_BUY_OPEN,
        OPT_OPTION_COVERED_CLOSE,
        OPT_OPTION_CALL_EXERCISE,
        OPT_N3B_PRICE_BUY,
        OPT_N3B_CONFIRM_BUY,
        OPT_N3B_REPORT_CONFIRM_BUY,
        OPT_N3B_LIMIT_PRICE_BUY,
        OPT_NEEQ_O3B_LIMIT_PRICE_BUY,
        OPT_FUND_SUBSCRIBE,
        OPT_FUND_PRICE_BUY,
        OPT_ETF_PURCHASE,
        OPT_FUND_MERGE,
        OPT_OUTER_BUY,
        OPT_IBANK_BOND_BUY,
        OPT_DISTRIBUTION_BUYING,
        OPT_IBANK_FUND_REPURCHASE,
        OPT_IBANK_BOND_REPAY,
        OPT_GOLD_PRICE_MIDDLE_BUY,
        OPT_GOLD_PRICE_DELIVERY_BUY,
        OPT_BLOCK_INTENTION_BUY,
        OPT_BLOCK_PRICE_BUY,
        OPT_BLOCK_CONFIRM_BUY,
        OPT_BLOCK_CONFIRM_MATCH_BUY,
        OPT_BLOCK_CLOSE_PRICE_BUY,
        OPT_COLLATERAL_TRANSFER_IN,
        OPT_N3B_CALL_AUCTION_BUY,
        OPT_N3B_AFTER_HOURS_BUY,
        OPT_CLOSE_SHORT,
        OPT_PLEDGE_OUT,
        OPT_AFTER_FIX_BUY,
        OPT_QUOTATION_REPURCHASE_BUY,
        OPT_OPTION_SECU_LOCK,
        OPT_NEEQ_O3B_CONTINUOUS_AUCTION_BUY,
        OPT_NEEQ_O3B_ASK_PRICE,
        OPT_NEEQ_O3B_PRICE_CONFIRM,
        OPT_NEEQ_O3B_BLOCKTRADING_BUY,
        OPT_TRANSACTION_IN_CASH_BUY,
        OPT_OUTRIGHT_REPO_FUND_REPURCHASE,
        OPT_OUTRIGHT_REPO_BOND_REPAY,
        OPT_AGREEMENT_REPURCHASE_TRANSACTION_DEC_FORWARD,
        OPT_AGREEMENT_REPURCHASE_ADVANCE_REPURCHASE,
        OPT_AGREEMENT_REPURCHASE_EXPIRE_RENEW,
        OPT_AGREEMENT_REPURCHASE_INTENTION_BUY,
        OPT_FINANCIAL_PRODUCT_BUY,
        OPT_FINANCIAL_PRODUCT_CALL,
        OPT_OPTION_RELEASE_COMB_STRATEGY,
        OPT_OTC_NON_CONTRACTUAL_DEPOSIT,
        OPT_OTC_CONTRACTUAL_DEPOSIT,
        OPT_OTC_FUND_SUBSCRIBE,
        OPT_OTC_FUND_PURCHASE,
        OPT_OTC_CONTRACTUAL_DEPOSIT_ASK,
        OPT_OTC_NON_CONTRACTUAL_DEPOSIT_ASK,
        OPT_CONVERT_BONDS,
        OPT_OFF_IPO_PUB_PRICE,
        OPT_OFF_IPO_PUB_PURCHASE,
        OPT_OFF_IPO_NON_PUB_PRICE,
        OPT_OFF_IPO_NON_PUB_PURCHASE,
        OPT_OPTION_BUY_CLOSE_THEN_OPEN,
        OPT_FICC_MANUAL_DECLARE_BUY,
        OPT_FICC_MANUAL_CONFIRM_BUY_CONFIRM,
        OPT_FICC_MANUAL_CONFIRM_BUY_REJECT,
        OPT_FICC_CONSULT_DECLARE_BUY,
        OPT_FICC_CONSULT_CONFIRM_BUY_CONFIRM,
        OPT_FICC_CONSULT_CONFIRM_BUY_REJECT,
        OPT_FICC_ENQUIRY_DECLARE_BUY,
        OPT_FICC_ENQUIRY_REPLAY_BUY_CONFIRM,
        OPT_FICC_ENQUIRY_REPLAY_BUY_REJECT,
        OPT_FICC_ENQUIRY_INQUIRY_BUY_CONFIRM,
        OPT_FICC_ENQUIRY_INQUIRY_BUY_REJECT,
        OPT_FICC_BINDDING_RESERVE_BUY,
        OPT_FICC_BINDDING_DECLARE_BUY,
        OPT_FICC_BINDDING_PRICE_DECLARE_BUY,
        OPT_FUND_TRANSFER_IN,
    ):
