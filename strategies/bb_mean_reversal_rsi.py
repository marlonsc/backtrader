...
Args:
    ...
    def stop(self):
        ...
        self.log(
            "      It performs poorly in trending markets where price can remain at"
            " extremes"
        )
        self.log(
...
def main():
    ...
    print(
        f"Bollinger Bands: Period={args.bb_length}, Mult={args.bb_mult},"
        f" Type={args.matype}"
    )
    print(
    ...
    print(
        "territories for extended periods. Best used in markets with clear trading"
        " ranges"
    )
