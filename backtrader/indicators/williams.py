...
class WilliamsR(Indicator):
    """Developed by Larry Williams to show the relation of closing prices to the highest-
    lowest range of a given period.
...
class WilliamsAD(Indicator):
    ...
    (upwards) or distributing (downwards) by using the concept of UpDays and DownDays.
