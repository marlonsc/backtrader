...
class OrderExecutionBit:
    """Intended to hold information about order execution. A "bit" does not determine if
    the order has been fully/partially executed, it just holds information.
...
class OrderBase(with_metaclass(MetaParams, object)):
    ...
    def addinfo(self, **kwargs):
        """Add the keys, values of kwargs to the internal info dictionary to hold custom
