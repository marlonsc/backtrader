...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, required=True, help='Stock symbol to dump data for (e.g., TSLA)')
    parser.add_argument('--fromdate', type=str, required=True, help='Start date in YYYY-MM-DD format')
    parser.add_argument('--todate', type=str, required=True, help='End date in YYYY-MM-DD format')
    parser.add_argument('--output', type=str, help='Output directory (defaults to logs directory)')
